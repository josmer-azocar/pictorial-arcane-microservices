...
import com.pictorialarcane.core_service.domain.service.SaleService;
...
public class SaleController {
    ...
    public ResponseEntity<Void> reserveArtWork(
            ...
            @Parameter(description = "Art Work price / Precio de la obra de arte", example = "1500.0")
            @RequestParam("price") Double price,
            @Parameter(description = "Commission rate / Tasa de comisión", example = "0.1")
