package com.pictorialarcane.core_service.persistence.entity;

import com.pictorialarcane.core_service.persistence.audit.AuditableEntity;
...
public class SaleEntity extends AuditableEntity {
    ...
    // Referencia plana a la obra (la obra vive en MongoDB, gestionada por el artwork-service).
    // No es FK física: la disponibilidad se sincroniza vía mensajería asíncrona.
