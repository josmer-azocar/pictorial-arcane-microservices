    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch">
          ...
          <div className="p-5 rounded-2xl bg-gradient-to-br from-purple-50 to-white border border-arcane-purple/10 shadow-sm arcane-glass-light flex flex-col justify-center">
            <div className="h-10 w-10 rounded-2xl bg-gradient-to-br from-arcane-purple/20 to-purple-100 flex items-center justify-center border border-arcane-purple/20 mb-3 shadow-sm">
              <Palette size={20} className="text-arcane-purple" />
            </div>
            <h3 className="font-display font-bold text-base text-gray-900 mb-2 tracking-tight">
          ...
          <div className="p-5 rounded-2xl bg-gradient-to-br from-amber-50 to-white border border-arcane-purple/10 shadow-sm arcane-glass-light flex flex-col justify-center">
            <div className="h-10 w-10 rounded-2xl bg-gradient-to-br from-amber-500/20 to-amber-100 flex items-center justify-center border border-amber-500/20 mb-3 shadow-sm">
        ...
        {/* Bottom summary */}
        <div className="mt-4 p-4 rounded-2xl bg-gray-50 border border-arcane-purple/10 text-center">
