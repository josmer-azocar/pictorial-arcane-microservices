      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch">
          ...
          <div className="lg:w-80 flex-shrink-0">
            <div className="p-6 rounded-2xl arcane-glass border border-arcane-purple/10 shadow-sm h-full" style={{ background: 'rgba(255, 255, 255, 0.85)', backdropFilter: 'blur(20px)', border: '1px solid rgba(124, 58, 237, 0.2)', boxShadow: '0 10px 30px rgba(124, 76, 219, 0.05)' }}>
          ...
          <div className="hidden lg:flex flex-col gap-4 items-center flex-shrink-0 sticky top-8 self-start z-10 mr-2">
            {(Object.keys(dictionaryItems) as DBEngine[]).map((engine) => (
              ...
              >
                ...
                <span className="absolute right-full mr-3 px-2.5 py-1 rounded-lg bg-white text-gray-900 text-[10px] font-mono font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none shadow-lg border border-gray-200">
                  {engine}
                </span>
              </button>
            ))}
