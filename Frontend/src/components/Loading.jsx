        ...
        <div style={{ 
            ...
            <style>{`
                .capybaraloader {
                    ...
                    --color2: rgb(88, 28, 135);
                    transform: scale(0.75);
                }
                .capybara { width: 100%; height: 7.5em; position: relative; z-index: 1; }
                .capy-loader { width: 100%; height: 2.5em; position: relative; z-index: 1; overflow: hidden; }
            ...
            <p style={{ color: '#7b2d8b', fontSize: '13px', fontWeight: 'bold', marginTop: '1em' }}>
                Por favor espera...
            </p>
        </div>
    );
